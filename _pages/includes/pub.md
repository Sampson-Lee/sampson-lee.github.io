...
**Omni-MMSI-R**, addressing the multimodal social interaction understanding in raw audio-video input, a reference-guided pipeline that leverages references to extract identity-attributed social cues and conducts CoT reasoning.
</div>
</div>
